...
class XyloContext {
 public:
  XyloContext() :
      ...
      numeric_symbol_(Symbol::Kind::kType, &root_scope_, InternIdentifier("Numeric")),
      float_symbol_(Symbol::Kind::kType, &root_scope_, InternIdentifier("float")),
      int_symbol_(Symbol::Kind::kType, &root_scope_, InternIdentifier("int")),
      string_symbol_(Symbol::Kind::kType, &root_scope_, InternIdentifier("string")),
      bottom_type_(),
